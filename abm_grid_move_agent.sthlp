...
{vieweralsosee "help abm_grid_move_agents" "help abm_grid_move_agents"}{...}
{p2colset 1 17 19 2}{...}
{p2col:{bf:move_agent()} {hline 2}}move an agent from one location to another.
{p_end}
{p2colreset}{...}
...
{p 8 12 2}
{it:void} 
{cmd:move_agent(}{it:real scalar ro}, {it:real scalar co}, 
...
{p 4 4 2}
{cmd:move_agent()} moves an agent from one coordinate to another coordinate. 
Moving an agent means that the {it:agent_id} is copied to the other coordinate 
and is removed from the original coordinate. The coordinate depends 
...
{title:Conformability}
    ...
    {cmd:move_agent(}{it:ro}, {it:co}, {it:rd}, {it:cd}{cmd:)}:
           {it:result}:   {it:void}
           {it:ro}:        1 {it:x} 1
           {it:co}:        1 {it:x} 1
           {it:rd}:        1 {it:x} 1
    ...
    {cmd:move_agent(}{it:ro}, {it:co}, {it:rd}, {it:cd}, {it:t}{cmd:)}:
           {it:result}:   {it:void}
           {it:ro}:        1 {it:x} 1
           {it:co}:        1 {it:x} 1
           {it:rd}:        1 {it:x} 1
    ...
    {cmd:move_agent(}{it:ro}, {it:co}, {it:rd}, {it:cd}, {it:to}, {it:td}{cmd:)}:
           {it:result}:   {it:void}
           {it:ro}:        1 {it:x} 1
           {it:co}:        1 {it:x} 1
           {it:rd}:        1 {it:x} 1
    ...
    {cmd:move_agent(}{it:ro}, {it:co}, {it:rd}, {it:cd}, {it:to}, {it:td}, {it:i}{cmd:)}:
           {it:result}:   {it:void}
           {it:ro}:        1 {it:x} 1
           {it:co}:        1 {it:x} 1
           {it:rd}:        1 {it:x} 1
    ...
    {cmd:move_agent(}{it:ro}, {it:co}, {it:rd}, {it:cd}, {it:to}, {it:td}, {it:io}, {it:id}{cmd:)}:
           {it:result}:   {it:void}
           {it:ro}:        1 {it:x} 1
           {it:co}:        1 {it:x} 1
           {it:rd}:        1 {it:x} 1
...
{p 4 4 2}
{cmd:move_agent()} aborts with an error if the destination already contains an 
agent.

{p 4 4 2}
{cmd:move_agent()} aborts with an error if {it:ro}, {it:rd}, {it:co} or 
...
{p 4 4 2}
{cmd:move_agent()} aborts with an error if {it:t}, {it:to}, or {it:td} is not an 
integer, or is less 0, or is more than {help abm_grid_rdim:tdim}.

{p 4 4 2}
{cmd:move_agent()} aborts with an error if {it:t}, {it:to}, or {it:td} has been 
specified while {help abm_grid_rdim:tdim} has been set to 0.

{p 4 4 2}
{cmd:move_agent()} aborts with an error if {it:i}, {it:io}, or {it:id} is not an 
integer, or is less than or equal to 0

{p 4 4 2} 
{cmd:move_agent()} aborts with an error if {it:i}, {it:io}, or {it:id} is more 
than {help abm_grid_rdim:idim} and {cmd:idim} has not been set to 0.

{p 4 4 2}
{cmd:move_agent()} aborts with an error if {it:i}, {it:io}, or {it:id} has been 
